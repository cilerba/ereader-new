...
SpriteData:
	dw CardSprite,CardPalette
	db $08,$08,$01,$01,$01,$01,$01 ; width 15, height 8
...
Instructions2: ; 199d
	...
	db "Sapphire to begin sending the event.\0"

DeliveryInProcess: ; 1a0d
	db "Event delivery in process...\0"
...
Start: ; 1ae2
	...
	SetBackgroundPalette 16, $0040, CardPalette
